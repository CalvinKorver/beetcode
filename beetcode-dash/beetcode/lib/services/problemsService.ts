...
export class ProblemsService {
  ...
  /**
   * Convert time format from extension to milliseconds
  ...
  async upsertProblem(problemData: {
    ...
    try {
      ...
      if (existingProblem) {
        ...
        if (problemData.best_time_ms &&
            (!existingProblem.best_time_ms || problemData.best_time_ms < existingProblem.best_time_ms)) {
          updates.best_time_ms = problemData.best_time_ms;
        }
