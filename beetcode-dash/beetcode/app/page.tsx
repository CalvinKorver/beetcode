          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="p-6 hover:shadow-lg transition-shadow">
              <CardContent className="p-0">
                ...
                <p className="text-muted-foreground">
                  Visual charts and insights showing your solving patterns, difficulty progression, and topic mastery.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="p-6 hover:shadow-lg transition-shadow">
              <CardContent className="p-0">
                ...
                <p className="text-muted-foreground">
                  Unlock badges and achievements as you progress through different topics and difficulty levels.
                </p>
              </CardContent>
            </Card>
      ...
      <section className="px-4 py-20 bg-gradient-to-r from-orange-50 to-red-50 dark:from-orange-950/20 dark:to-red-950/20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="text-sm text-muted-foreground">
            ✨ Free forever • 📊 Instant insights • 🚀 No registration required
          </div>
        </div>
      </section>
